...
export const NON_JUNIOR_DIV_TOPICS = [Topic.LISP, Topic.FSAsAndRegExp, Topic.AssemblyLang]
...
export const DIVISION_SELECT_SCHEMA: ComboboxItemGroup[] = 
    [1, 2, 3, 4].map(contestNum => ({
